...
class Process():
    ...
    def run(self):
        ...
        train_index = pd.read_csv(self.train_index_path, lineterminator='\r',
                                  header=None)
        validation_index = pd.read_csv(self.validation_index_path, lineterminator='\r',
                                       header=None)
        test_index = pd.read_csv(self.test_index_path, lineterminator='\r',
                                 header=None)
